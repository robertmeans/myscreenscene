...
<form class="searchform" name="page_number1" action="processing/page_number.php" method="post">
...
<div id="clockTopPad">&nbsp;</div><!-- clockTopPad -->
<!-- clock names start -->
...
<?php 
	if ((($user_data['a1_text_pg3']) == 'x') && (($user_data['b1_text_pg3']) == 'x') && (($user_data['c1_text_pg3']) == 'x') && (($user_data['d1_text_pg3']) == 'x') && (($user_data['a2_text_pg3']) == 'x') && (($user_data['b2_text_pg3']) == 'x') && (($user_data['c2_text_pg3']) == 'x') && (($user_data['d2_text_pg3']) == 'x') && (($user_data['a3_text_pg3']) == 'x') && (($user_data['b3_text_pg3']) == 'x') && (($user_data['c3_text_pg3']) == 'x') && (($user_data['d3_text_pg3']) == 'x') && (($user_data['a4_text_pg3']) == 'x') && (($user_data['b4_text_pg3']) == 'x') && (($user_data['c4_text_pg3']) == 'x') && (($user_data['d4_text_pg3']) == 'x') && (($user_data['a5_text_pg3']) == 'x') && (($user_data['b5_text_pg3']) == 'x') && (($user_data['c5_text_pg3']) == 'x') && (($user_data['d5_text_pg3']) == 'x') && (($user_data['a6_text_pg3']) == 'x') && (($user_data['b6_text_pg3']) == 'x') && (($user_data['c6_text_pg3']) == 'x') && (($user_data['d6_text_pg3']) == 'x')) { 
...
<!-- ***************************************************** row 1 begin **************************************************** -->   
<?php 
	if ((($user_data['a1_text_pg3']) == 'x') && (($user_data['b1_text_pg3']) == 'x') && (($user_data['c1_text_pg3']) == 'x') && (($user_data['d1_text_pg3']) == 'x')) { 
		include 'link_row_collapse/empty.php'; 
	} else { 
		include 'link_row_collapse/link_row1_pg3.php'; 
} 
?>
<!-- ****************************************************** row 1 end ***************************************************** -->
<!-- ****************************************************** row 2 begin *************************************************** -->    
<?php 
	if ((($user_data['a2_text_pg3']) == 'x') && (($user_data['b2_text_pg3']) == 'x') && (($user_data['c2_text_pg3']) == 'x') && (($user_data['d2_text_pg3']) == 'x')) { 
		include 'link_row_collapse/empty.php'; 
	} else { 
		include 'link_row_collapse/link_row2_pg3.php'; 
	} 
?>
<!-- ****************************************************** row 2 end ***************************************************** -->
<!-- ****************************************************** row 3 begin *************************************************** -->    
<?php 
	if ((($user_data['a3_text_pg3']) == 'x') && (($user_data['b3_text_pg3']) == 'x') && (($user_data['c3_text_pg3']) == 'x') && (($user_data['d3_text_pg3']) == 'x')) { 
		include 'link_row_collapse/empty.php'; 
	} else { 
		include 'link_row_collapse/link_row3_pg3.php'; 
	} 
?>
<!-- ****************************************************** row 3 end ***************************************************** -->
<!-- ****************************************************** row 4 begin *************************************************** -->    
<?php 
	if ((($user_data['a4_text_pg3']) == 'x') && (($user_data['b4_text_pg3']) == 'x') && (($user_data['c4_text_pg3']) == 'x') && (($user_data['d4_text_pg3']) == 'x')) { 
		include 'link_row_collapse/empty.php'; 
	} else { 
		include 'link_row_collapse/link_row4_pg3.php'; 
	} 
?>
<!-- ****************************************************** row 4 end ***************************************************** -->
<!-- ****************************************************** row 5 begin *************************************************** -->    
<?php 
	if ((($user_data['a5_text_pg3']) == 'x') && (($user_data['b5_text_pg3']) == 'x') && (($user_data['c5_text_pg3']) == 'x') && (($user_data['d5_text_pg3']) == 'x')) { 
		include 'link_row_collapse/empty.php'; 
	} else { 
		include 'link_row_collapse/link_row5_pg3.php'; 
	} 
?>
<!-- ****************************************************** row 5 end ***************************************************** -->
<!-- ****************************************************** row 6 begin *************************************************** -->    
<?php 
	if ((($user_data['a6_text_pg3']) == 'x') && (($user_data['b6_text_pg3']) == 'x') && (($user_data['c6_text_pg3']) == 'x') && (($user_data['d6_text_pg3']) == 'x')) { 
		include 'link_row_collapse/empty.php'; 
	} else { 
		include 'link_row_collapse/link_row6_pg3.php'; 
	} 
?>
<!-- ****************************************************** row 6 end ***************************************************** -->
</div><!-- linkBoxWrapper -->
...
<a href="#add_note" class="edit_window_add_note">Add a note</a>
	<div id="add_note" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
      ...
      <form name="myform" class="edit" action="processing/add_note.php" method="post">
            ...
            <textarea class="textareaAddNote" name="desc" style="width:350px; height:50px;" wrap="soft" cols="5" maxlength="140"></textarea></label>
