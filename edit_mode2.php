...
<form class="searchform" name="page_number1" action="processing/page_number_edit_mode.php" method="post">
<input type="hidden" name="page_number" value="1">
<a href="javascript:document.page_number1.submit();" class="page_nav">1</a>
</form>

<div class="page_nav_selected">2</div><!-- page_nav_selected -->
...
<!-- ***************************************************** row 1 begin **************************************************** -->   
    ...
    <div class="container">   
    <a href="#edit_link_a1_pg2" class="edit_window"><?php echo stripslashes($user_data['a1_text_pg2']); ?></a>
            <div id="edit_link_a1_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/a1_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="a1_url_pg2" type="text" value="<?php echo $user_data['a1_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="a1_text_pg2" type="text" value="<?php echo stripslashes($user_data['a1_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_b1_pg2" class="edit_window"><?php echo stripslashes($user_data['b1_text_pg2']); ?></a>
            <div id="edit_link_b1_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/b1_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="b1_url_pg2" type="text" value="<?php echo $user_data['b1_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="b1_text_pg2" type="text" value="<?php echo stripslashes($user_data['b1_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_c1_pg2" class="edit_window"><?php echo stripslashes($user_data['c1_text_pg2']); ?></a>
            <div id="edit_link_c1_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/c1_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="c1_url_pg2" type="text" value="<?php echo $user_data['c1_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="c1_text_pg2" type="text" value="<?php echo stripslashes($user_data['c1_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_d1_pg2" class="edit_window"><?php echo stripslashes($user_data['d1_text_pg2']); ?></a>
            <div id="edit_link_d1_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/d1_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="d1_url_pg2" type="text" value="<?php echo $user_data['d1_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="d1_text_pg2" type="text" value="<?php echo stripslashes($user_data['d1_text_pg2']); ?>" maxlength="30">
...
<!-- ****************************************************** row 2 begin *************************************************** -->    
    ...
    <div class="container">   
    <a href="#edit_link_a2_pg2" class="edit_window"><?php echo stripslashes($user_data['a2_text_pg2']); ?></a>
            <div id="edit_link_a2_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/a2_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="a2_url_pg2" type="text" value="<?php echo $user_data['a2_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="a2_text_pg2" type="text" value="<?php echo stripslashes($user_data['a2_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_b2_pg2" class="edit_window"><?php echo stripslashes($user_data['b2_text_pg2']); ?></a>
            <div id="edit_link_b2_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/b2_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="b2_url_pg2" type="text" value="<?php echo $user_data['b2_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="b2_text_pg2" type="text" value="<?php echo stripslashes($user_data['b2_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_c2_pg2" class="edit_window"><?php echo stripslashes($user_data['c2_text_pg2']); ?></a>
            <div id="edit_link_c2_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/c2_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="c2_url_pg2" type="text" value="<?php echo $user_data['c2_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="c2_text_pg2" type="text" value="<?php echo stripslashes($user_data['c2_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_d2_pg2" class="edit_window"><?php echo stripslashes($user_data['d2_text_pg2']); ?></a>
            <div id="edit_link_d2_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/d2_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="d2_url_pg2" type="text" value="<?php echo $user_data['d2_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="d2_text_pg2" type="text" value="<?php echo stripslashes($user_data['d2_text_pg2']); ?>" maxlength="30">
...
<!-- ****************************************************** row 3 begin *************************************************** -->    
    ...
    <div class="container">   
    <a href="#edit_link_a3_pg2" class="edit_window"><?php echo stripslashes($user_data['a3_text_pg2']); ?></a>
            <div id="edit_link_a3_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/a3_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="a3_url_pg2" type="text" value="<?php echo $user_data['a3_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="a3_text_pg2" type="text" value="<?php echo stripslashes($user_data['a3_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_b3_pg2" class="edit_window"><?php echo stripslashes($user_data['b3_text_pg2']); ?></a>
            <div id="edit_link_b3_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/b3_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="b3_url_pg2" type="text" value="<?php echo $user_data['b3_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="b3_text_pg2" type="text" value="<?php echo stripslashes($user_data['b3_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_c3_pg2" class="edit_window"><?php echo stripslashes($user_data['c3_text_pg2']); ?></a>
            <div id="edit_link_c3_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/c3_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="c3_url_pg2" type="text" value="<?php echo $user_data['c3_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="c3_text_pg2" type="text" value="<?php echo stripslashes($user_data['c3_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_d3_pg2" class="edit_window"><?php echo stripslashes($user_data['d3_text_pg2']); ?></a>
            <div id="edit_link_d3_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/d3_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="d3_url_pg2" type="text" value="<?php echo $user_data['d3_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="d3_text_pg2" type="text" value="<?php echo stripslashes($user_data['d3_text_pg2']); ?>" maxlength="30">
...
<!-- ****************************************************** row 4 begin *************************************************** -->    
    ...
    <div class="container">   
    <a href="#edit_link_a4_pg2" class="edit_window"><?php echo stripslashes($user_data['a4_text_pg2']); ?></a>
            <div id="edit_link_a4_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/a4_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="a4_url_pg2" type="text" value="<?php echo $user_data['a4_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="a4_text_pg2" type="text" value="<?php echo stripslashes($user_data['a4_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_b4_pg2" class="edit_window"><?php echo stripslashes($user_data['b4_text_pg2']); ?></a>
            <div id="edit_link_b4_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/b4_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="b4_url_pg2" type="text" value="<?php echo $user_data['b4_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="b4_text_pg2" type="text" value="<?php echo stripslashes($user_data['b4_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_c4_pg2" class="edit_window"><?php echo stripslashes($user_data['c4_text_pg2']); ?></a>
            <div id="edit_link_c4_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/c4_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="c4_url_pg2" type="text" value="<?php echo $user_data['c4_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="c4_text_pg2" type="text" value="<?php echo stripslashes($user_data['c4_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_d4_pg2" class="edit_window"><?php echo stripslashes($user_data['d4_text_pg2']); ?></a>
            <div id="edit_link_d4_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/d4_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="d4_url_pg2" type="text" value="<?php echo $user_data['d4_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="d4_text_pg2" type="text" value="<?php echo stripslashes($user_data['d4_text_pg2']); ?>" maxlength="30">
...
<!-- ****************************************************** row 5 begin *************************************************** -->    
    ...
    <div class="container">   
    <a href="#edit_link_a5_pg2" class="edit_window"><?php echo stripslashes($user_data['a5_text_pg2']); ?></a>
            <div id="edit_link_a5_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/a5_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="a5_url_pg2" type="text" value="<?php echo $user_data['a5_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="a5_text_pg2" type="text" value="<?php echo stripslashes($user_data['a5_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_b5_pg2" class="edit_window"><?php echo stripslashes($user_data['b5_text_pg2']); ?></a>
            <div id="edit_link_b5_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/b5_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="b5_url_pg2" type="text" value="<?php echo $user_data['b5_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="b5_text_pg2" type="text" value="<?php echo stripslashes($user_data['b5_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_c5_pg2" class="edit_window"><?php echo stripslashes($user_data['c5_text_pg2']); ?></a>
            <div id="edit_link_c5_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/c5_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="c5_url_pg2" type="text" value="<?php echo $user_data['c5_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="c5_text_pg2" type="text" value="<?php echo stripslashes($user_data['c5_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_d5_pg2" class="edit_window"><?php echo stripslashes($user_data['d5_text_pg2']); ?></a>
            <div id="edit_link_d5_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/d5_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="d5_url_pg2" type="text" value="<?php echo $user_data['d5_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="d5_text_pg2" type="text" value="<?php echo stripslashes($user_data['d5_text_pg2']); ?>" maxlength="30">
...
<!-- ****************************************************** row 6 begin *************************************************** -->    
    ...
    <div class="container">   
    <a href="#edit_link_a6_pg2" class="edit_window"><?php echo stripslashes($user_data['a6_text_pg2']); ?></a>
            <div id="edit_link_a6_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/a6_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="a6_url_pg2" type="text" value="<?php echo $user_data['a6_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="a6_text_pg2" type="text" value="<?php echo stripslashes($user_data['a6_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_b6_pg2" class="edit_window"><?php echo stripslashes($user_data['b6_text_pg2']); ?></a>
            <div id="edit_link_b6_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/b6_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="b6_url_pg2" type="text" value="<?php echo $user_data['b6_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="b6_text_pg2" type="text" value="<?php echo stripslashes($user_data['b6_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_c6_pg2" class="edit_window"><?php echo stripslashes($user_data['c6_text_pg2']); ?></a>
            <div id="edit_link_c6_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/c6_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="c6_url_pg2" type="text" value="<?php echo $user_data['c6_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="c6_text_pg2" type="text" value="<?php echo stripslashes($user_data['c6_text_pg2']); ?>" maxlength="30">
    ...
    <div class="container">   
    <a href="#edit_link_d6_pg2" class="edit_window"><?php echo stripslashes($user_data['d6_text_pg2']); ?></a>
            <div id="edit_link_d6_pg2" class="edit_popup"><a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
              <form method="post" class="edit" action="processing/d6_process_pg2.php">
                    <fieldset class="textbox"><label class="url"><span>URL</span>
                    
                    <input name="d6_url_pg2" type="text" value="<?php echo $user_data['d6_url_pg2']; ?>" maxlength="1024">
                    </label><label class="text"><span>Label - limit 30 characters</span>
                    
                    <input name="d6_text_pg2" type="text" value="<?php echo stripslashes($user_data['d6_text_pg2']); ?>" maxlength="30">
