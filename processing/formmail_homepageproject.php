...
<title>MyScreenScene - Message Received</title>
...
<body>
    ...
    Hello <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?>,<br>
  <br>
  Your message was sent successfully. I will see it soon.<br>
  <br>
	Robert    
